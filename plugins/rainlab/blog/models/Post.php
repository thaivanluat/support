...
class Post extends Model
{
    ...
    public static $allowedSortingOptions = [
        ...
        'ordinal asc'       => 'rainlab.blog::lang.sorting.ordinal_asc',
        'ordinal desc'      => 'rainlab.blog::lang.sorting.ordinal_desc',
    ];
    ...
    public function scopeListFrontEnd($query, $options)
    {
        ...
        if (in_array($sort, array_keys(static::$allowedSortingOptions))) {
            if ($sort == 'random') {
                ...
                $query->orderBy($sortField, $sortDirection)->orderBy('published_at','desc');
            }
        }
