...
class CategoryTwoLevel extends ComponentAbstract
{
      /**
    ...
    /**
     * Author: Truong Bui
     * Reference to the category slug default when category2 is null
     *
     * @var string
     */
    public $categoryChildSlugDefault;

    public function componentDetails()
    {
        return [
            'name'        => 'rainlab.blog::lang.settings.CategoryTwoLevel',
            'description' => 'rainlab.blog::lang.settings.CategoryTwoLevel_description'
        ];
    }
    ...
    public function onRun()
    {
        ...
        //get current category slug and post slug on url
        ...
        //get list category child to show in sidebar
        ...
        //if category2 slug == null
        $this->categoryChildSlugDefault = $this->categoriesChild->first()->slug;

        $this->categoryChild = $this->currentCategorySlug2 ? $this->loadCategory($this->currentCategorySlug2)->first(): $this->loadCategory($this->categoryChildSlugDefault)->first();

        //Get post slug default to show on sidebar
        $this->setPostSlugDefault();

        $this->posts = $this->listPosts($this->categoryChild->id);
