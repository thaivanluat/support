...
return [
    ...
    'settings' => [
        ...
        'posts_video' => 'PostsVideo',
        'category_master' => 'Category master',
        'category_filter' => 'Category parent filter',
        'CategoryTwoLevel' => 'Category two level',
        'CategoryThreeLevel' => 'Category three level',
        'CategoryTwoLevel_description' => 'Displays a blog post with category two level on the page.',
        'CategoryThreeLevel_description' => 'Displays a blog post with category three level on the page.',
        'posts_filter_by_category' => 'Posts Filter by category',
        'posts_filter_by_category_description' => 'Display all list posts Filter by category',
        'category_parent' => 'Category filter',
    ],
    'sorting' => [
        ...
        'random' => 'Random',
        'ordinal_asc' => 'Ordinal (ascending)',
        'ordinal_desc' => 'Ordinal (descending)',
    ],
    'import' => [
